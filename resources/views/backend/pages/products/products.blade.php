...
<div class="box">
 ...
 <a href="{{ route('products.create') }}" class="btn btn-success col-lg-offset-3">Add New</a>
            ...
            <tr>
              ...
              <td>{{ $product->quantity }}</td>
                <td>
                  ...
                  <a href="{{ route('products.edit', $product->id) }}" class="btn btn-success"><span class="glyphicon glyphicon-edit"></span></a>
